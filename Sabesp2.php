...
class Get_Tabela($mes,$ano){//Gerará a variável $tabela
...
class Get_Dados($tabela){//Gerará a variável $dados
...
class CSV($nome, $cabecalho, $dados){//Gera o arquivo CSV para Download
...
class Baixar_Tabelas($anoInicial, $anoFinal){//Gera CSV's em massa EXPERIMENTAL
...
$cabecalho= array('Data','NA (m)','Pluv (mm)','Qjus (m3/s)','NA (m)','Pluv (mm)','Qjus (m3/s)','NA (m)','Pluv (mm)','Qjus (m3/s)','NA (m)','Pluv (mm)','Qjus (m3/s)','NA (m)','Pluv (mm)','Qjus (m3/s)','F-25Bt (m3/s)','Q T7 (m3/s)','Q T6 (m3/s)','Q T5 (m3/s)', 'Q ESI (m3/s)');
$tabela= new Get_Tabela(3,2017);
//print_r($tabela);
$dados= new Get_Dados($tabela);
print_r($dados);
$data_tabela= explode('01/', $dados[0][0][0]);
$data= implode("",$data_tabela);
//print_r($data);
